## PerSenT
# Person SenTiment analysis dataset


### This is a challenge dataset for author's sentiment analysis in news domain. 

This dataset is introduced in [Author's sentiment analysis]() 
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/MHDBST/PerrSenT/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
